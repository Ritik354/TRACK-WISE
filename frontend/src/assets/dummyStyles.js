export const dashboardStyles = {
  ...
  // Header styles
  headerContainer:
    "bg-gradient-to-r from-emerald-500/10 to-teal-500/10 backdrop-blur-lg rounded-3xl p-6 mb-8 shadow-lg border border-white/30",
  headerContent:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8",
  headerTitle:
    "text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-700 bg-clip-text text-transparent",
  headerSubtitle: "text-gray-600 mt-2",

  // Button styles
  addButton:
    "flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-3 rounded-xl transition-all shadow hover:shadow-md font-medium",

  // Time frame selector styles
  timeFrameContainer: "flex justify-end mt-4",
  timeFrameWrapper:
    "flex gap-0 bg-white p-1 -mx-5 rounded-xl border border-gray-200",
  ...
  balanceBadge: "bg-emerald-100 text-emerald-800 px-2 py-1 rounded-lg text-xs",
  expenseBadge: "bg-indigo-100 text-indigo-800 px-1 py-1 rounded-lg text-xs",
  ...
  pieChartContainer:
    "hidden md:block bg-white lg:-mx-5.5 md:-mx-4 lg:p-1 xl:-mx-3 rounded-xl p-5 shadow-sm border border-gray-100 relative overflow-hidden mb-8",
  pieChartHeader:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  pieChartTitle:
    "text-xl lg:pt-3 xl:pl-3 font-bold text-gray-800 mb-5 flex items-center gap-3",
  pieChartSubtitle:
    "text-sm lg:text-center xl:text-start xl:pl-3 text-gray-500 mb-3",
  ...
  listContainer:
    "bg-white rounded-2xl lg:p-5 md:p-6 -mx-8 md:-mx-3 shadow-sm border border-gray-100",
  listHeader:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-5 gap-3",
  listTitle:
    "text-xl font-bold text-gray-800 md:mt-3 mt-3 flex items-center gap-3",
  listSubtitle: "text-sm text-gray-500 font-normal",

  // Record count badges
  incomeCountBadge:
    "text-sm bg-emerald-100 px-2 mx-2 text-emerald-800 md:mx-2 md:mt-2 py-1 rounded-full",
  expenseCountBadge:
    "text-sm bg-indigo-100 text-indigo-800 px-2 mx-2 md:mx-2 md:mt-2 py-1 rounded-full",

  // Transaction item styles
  transactionList: "space-y-3",
  incomeTransactionItem:
    "flex items-center px-2 mx-2 my-2 md:p-4 md:mx-2 lg:px-3 justify-between p-3 bg-emerald-50 rounded-lg",
  expenseTransactionItem:
    "flex items-center justify-between mx-1 p-3 lg:p-3 md:p-4 md:mx-2 bg-indigo-50 rounded-lg",

  // Transaction icon container
  incomeIconContainer: "p-2 bg-emerald-100 rounded-lg",
  expenseIconContainer: "p-2 bg-indigo-100 rounded-lg",
  ...
  expenseAmount: "font-bold text-indigo-600",
  ...
  viewAllButton:
    "w-full flex items-center justify-center gap-2 py-3 text-emerald-600 font-medium hover:bg-emerald-50 rounded-xl transition-colors",

  // Icon container styles
  iconContainer: (color) => `p-2 ${color} rounded-lg`,

  // Specific icon colors
  walletIconContainer: "p-2 bg-emerald-100 rounded-lg",
  arrowDownIconContainer: "p-2 bg-indigo-100 rounded-lg",
  piggyBankIconContainer: "p-2 bg-teal-100 rounded-lg",
};
...
export const incomeStyles = {
  ...
  addButton:
    "flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-3 py-2 md:px-4 md:py-3 rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg font-medium text-sm md:text-base",
  ...
  filterSelect:
    "appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent w-full",
  exportButton:
  ...
  viewAllButton:
    "mt-4 w-full text-center py-3 text-emerald-600 font-medium hover:bg-emerald-50 rounded-xl transition-colors flex items-center justify-center gap-2",

  // Empty State
  emptyStateContainer: "text-center py-6 md:py-8",
  emptyStateIcon:
    "w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-emerald-50 flex items-center justify-center",
...
export const expensePageStyles = {
  ...
  addButton:
    "flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 text-white px-4 py-3 rounded-xl transition-all shadow-md hover:shadow-lg font-medium",
  ...
  transactionsTitle:
    "text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  filterSelect:
    "appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full",

  // Transaction items
  transactionsList: "space-y-3 -mx-2 lg:-mx-0 md:-mx-0",
  viewAllButton:
    "mt-4 w-full text-center py-3 text-indigo-600 font-medium hover:bg-indigo-50 rounded-xl transition-colors flex items-center justify-center gap-2",
  emptyState: "text-center py-8",
  emptyStateIcon:
    "w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 flex items-center justify-center",
  emptyStateText: "text-gray-600 font-medium",
  emptyStateSubtext: "text-sm text-gray-500 mt-2",

  // Icons
  iconOrange: "p-2 bg-indigo-100 rounded-lg",
  iconAmber: "p-2 bg-blue-100 rounded-lg",
  iconYellow: "p-2 bg-purple-100 rounded-lg",
  textOrange: "text-indigo-600",
  textAmber: "text-blue-600",
  textYellow: "text-purple-600",

  // Borders
  borderOrange: "border-l-4 border-indigo-500",
  borderAmber: "border-l-4 border-blue-500",
  borderYellow: "border-l-4 border-purple-500",
  // Chart tooltip styles
  tooltipContent: {
    backgroundColor: "rgba(255, 255, 255, 0.95)",
    border: "1px solid #e5e7eb",
  ...
  transactionItemContainer:
    "flex items-center justify-between p-3 -mx-2 hover:bg-indigo-50 rounded-xl transition-all duration-300 border border-gray-100 cursor-pointer mb-3 group",
...
export const profileStyles = {
  ...
  icon: "w-5 h-5 mr-2 text-emerald-600",

  // Form styles
  label: "text-sm text-gray-500  block mb-1",
  input:
    "w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",
  inputWithError:
    "w-full px-4 py-2 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",

  // Button styles
  buttonPrimary:
    "flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-2.5 rounded-xl font-medium shadow-md",
  buttonSecondary:
    "flex-1 py-2.5 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-100",
  editButton: "text-emerald-600 hover:text-emerald-700 font-medium text-sm",
  changeButton:
    "text-emerald-600 hover:text-emerald-700 font-medium lg:text-sm",
...
export const modalStyles = {
  ...
  colorClasses: {
    teal: {
      ...
      typeButtonSelected: "bg-emerald-500",
    },
    orange: {
      button:
        "bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600",
      ring: "focus:ring-indigo-500",
      typeButtonSelected: "bg-indigo-500",
    },
  },
};
...
export const loginStyles = {
  // Page container
  pageContainer:
    "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-emerald-50 to-teal-50",
  ...
  // Header styles
  header: "bg-gradient-to-r from-emerald-500 to-teal-600 p-6 text-center",
  avatar:
    "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-emerald-100 mt-2",
  ...
  input:
    "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",
  passwordInput:
    "w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",
  passwordToggle:
    "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  checkbox:
    "w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500",
  checkboxLabel: "ml-2 block text-sm text-gray-700",

  // Button
  button:
    "w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
  buttonDisabled: "opacity-80 cursor-not-allowed",

  // Sign up link
  signUpContainer: "mt-8 text-center",
  signUpText: "text-gray-600",
  signUpLink: "font-medium text-emerald-600 hover:underline",
...
export const navbarStyles = {
  ...
  // Text styles
  logoText:
    "lg:text-3xl md:text-3xl text-2xl text-gray-900 font-[550] font-poppins",
  ...
  userAvatar:
    "w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-600 to-teal-500 text-white font-bold text-lg",
  statusIndicator:
  ...
  userName:
    "text-sm font-medium text-gray-800 truncate max-w-[120px] font-poppins",
  userEmail: "text-xs text-gray-500 truncate max-w-[120px] font-inter",
  chevronIcon: (isOpen) =>
  ...
  dropdownAvatar:
    "w-10 h-10 rounded-full bg-gradient-to-br from-emerald-600 to-teal-500 flex items-center justify-center text-white font-bold text-lg",
  dropdownName: "text-sm text-gray-800 font-poppins font-medium",
  dropdownEmail: "text-xs text-gray-500 font-inter",

  // Menu items
  menuItemContainer: "p-1.5",
  menuItem:
    "w-full px-4 py-3 text-left hover:bg-gray-50 text-sm text-gray-700 flex items-center gap-3 rounded-lg font-poppins",
  menuItemBorder: "p-1.5 border-t border-gray-100",
  logoutButton:
    "flex w-full items-center gap-3 px-4 py-3 text-sm hover:bg-red-50 text-red-600 rounded-lg font-poppins",
};
...
export const signupStyles = {
  ...
  header:
    "bg-gradient-to-r from-emerald-500 to-teal-600 p-6 text-center relative",
  avatar:
    "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-emerald-100 mt-2",
  ...
  inputIcon:
    "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
  input:
    "w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",
  passwordInput:
    "w-full pl-10 pr-10 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-emerald-300 focus:border-emerald-500",
  passwordToggle:
    "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  signInLink: "font-medium text-emerald-600 hover:underline",
